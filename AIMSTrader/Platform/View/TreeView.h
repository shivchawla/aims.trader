...
#include <QLabel>
#include <algorithm>
#include "Platform/View/TreeCellItem.h"
#include <QMenu>
#include <QAction>
...
class TreeView : public QTreeWidget
{
    ...
    public:
       ...
       TreeCellItem<ViewItem>* getTableItem(const int, const int);
...
template<class View, class ViewItem, class Model, class ModelColumn>
TreeView<View, ViewItem, Model, ModelColumn>::TreeView(QWidget* parent):QTreeWidget(parent)
{
    _model = new Model();
    _numRows = 0;
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::setupLooks()
{
    setUpdatesEnabled(true);
    verticalHeader()->hide();
    setEditTriggers(QAbstractItemView::NoEditTriggers);
    setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    QHeaderView* hHeader = QTreeWidget::horizontalHeader();
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::resizeEvent(QResizeEvent* event)
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::closeEvent(QCloseEvent *event)
{
    hide();
}

template<class View, class ViewItem, class Model, class ModelColumn>
TreeCellItem<ViewItem>* TreeView<View, ViewItem, Model, ModelColumn>::getTableItem(const int row, const int column)
{
    return static_cast<TreeCellItem<ViewItem>*>(item(row, column));
}

template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::editHeader(const QString column)
{
    _header<<column;
}

template<class View, class ViewItem, class Model, class ModelColumn>
ViewItem* TreeView<View, ViewItem, Model, ModelColumn>::addItemInView()
{
    setSortingEnabled (false);
    ViewItem* nItem = new ViewItem<Model, ModelColumn>(this);
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::insertItem(ViewItem* item)
{
    addTopLevelItem(item);
}

template<class View, class ViewItem, class Model, class ModelColumn>
const int TreeView<View, ViewItem, Model, ModelColumn>::getViewColumn(const int trueColumnModel)
{
    return -1;
}

template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::setView()
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::setHeaders()
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::setupMenu()
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::removeHeader()
{
    setSortingEnabled (false);
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::customizeHeader()
{

}

template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::headerContextMenuEvent(QContextMenuEvent*  event)
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
bool TreeView<View, ViewItem, Model, ModelColumn>::eventFilter(QObject *obj, QEvent *event)
{
    switch(event->type())
    {
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::modifyHeader(const int modelColumn)
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::addHeader(const QString& header)
{
...
template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::addRoot()
{

}

template<class View, class ViewItem, class Model, class ModelColumn>
void TreeView<View, ViewItem, Model, ModelColumn>::addChild()
{
