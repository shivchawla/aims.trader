#ifndef TREECELLITEM_H
#define TREECELLITEM_H
...
class TreeCellItem : public QTreeWidgetItem
{
    private:
        QVariant _data;
        QString _stringData;
    ...
    public:
        TreeCellItem(ViewItem* parent=0);
...
///constructor
template<class ViewItem>
TreeCellItem<ViewItem>::TreeCellItem(ViewItem* parent):QTreeWidgetItem()
{
    _parent = parent;
